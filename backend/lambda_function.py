...
LOCAL_RAW_PATH = os.path.join(os.path.dirname(__file__), "tests", "mock_s3", "raw-data")
LOCAL_CLEAN_PATH = os.path.join(os.path.dirname(__file__), "tests", "mock_s3", "normalized-data")
